# Set some variables.
ReferenceInputFile="LongGeneratedReference.fasta"
ReadInputFile="BC26Strand2Reads.fastq"
AlignmentPrefix="ReadsAgainstGeneratedReference"
...
minimap2 -ax map-ont $ReferenceIndex $ReadInputFile | samtools view -b | samtools sort -o $AlignmentBam
