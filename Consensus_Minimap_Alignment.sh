# Set some variables.
ReferenceInputFile="SstoOrgReference.fasta"
ReadInputFile="GeneSequences.fasta"
AlignmentPrefix="ClassIIAgainstSsto"
...
minimap2 -ax asm5 $ReferenceIndex $ReadInputFile | samtools view -b | samtools sort -o $AlignmentBam
